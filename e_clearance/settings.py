...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'django_filters',
    'whitenoise',  # Added for production static files
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Moved here (must be after security)
...
# Use DATABASE_URL if available, otherwise SQLite
DATABASES = {
...
# ========== STATIC & MEDIA FILES - END ==========

# WeasyPrint settings
WEASYPRINT = {
    'BASE_URL': config('WEASYPRINT_BASE_URL', default='http://localhost:8000'),
}
...
# ========== PRODUCTION SECURITY SETTINGS - BEGIN ==========
if not DEBUG:
...
# ========== PRODUCTION SECURITY SETTINGS - END ==========
